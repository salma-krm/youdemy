                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="?route=deletecategorie&id=<?= ($categorie->id); ?>"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form name="player" id="addPlayr" method="post"
                                                    action="http://localhost:8081/youdemy/?route=updateCategorie&id=<?= ($categorie->id); ?>">
                                                    <div class="bg-light p-4 rounded shadow-sm">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="description" id="description"
                                                                value="<?= ($categorie->description); ?>" class="form-control"
